...
var carsdata = [
  ...
  CarsData(
      ...
      desc: 'Land Rover Range Rover 2022 adalah 5 Seater SUV yang tersedia dalam daftar harga Rp 3,7 - Rp 4,2 Milyar di Indonesia. Ini tersedia dalam 8 warna, 2 varian, 1 pilihan mesin, dan 1 opsi transmisi: Otomatis di Indonesia. Mobil ini memiliki ground clearance 220 mm dengan dimensi sebagai berikut: 5200 mm L x 2073 mm W x 1869 mm H. Pesaing terdekat Land Rover Range Rover adalah Cayenne, LX dan Range Rover Sport.',
      price: '4.2 M',
      spec: 'Tempat Duduk : 5 Kursi \nMesin : 2995cc\nTenaga : 355 hp\nSteering : Ya\nKantong Udara Pengemudi : Ya \nAnti Lock Braking System : Ya\nTransmisi : Automatic\nGround Clearance	: 220 mm',
      star: '4.9',
      release: '2022',
      madeby: 'Land Rover',
      imageAsset: 'gambar/rangerover.png',
      imageUrls: [
        'gambar/rangerover/rangedepan.png',
        'gambar/rangerover/rangesamping.png',
        'gambar/rangerover/rangebelakang.png',
        'gambar/rangerover/rangedashboard.png',
        'gambar/rangerover/rangekursi.png',
      ],
  ),
  CarsData(
      name: 'TOYOTA 86',
      desc: 'Toyota 86 2022 adalah 4 Seater Coupe yang tersedia dengan harga Rp 830 Juta di Indonesia. Ini tersedia dalam 7 warna, 1 varian, 1 pilihan mesin, dan 1 opsi transmisi: Otomatis di Indonesia. Dimensi 86 adalah 4240 mm L x 1775 mm W x 1320 mm H. Lebih dari 4 pengguna telah memberikan penilaian untuk 86 berdasarkan fitur, jarak tempuh, kenyamanan tempat duduk dan kinerja mesin. Cicilan bulanan terendah dimulai dari Rp 169,35 Juta (selama 60 bulan). Pesaing terdekat Toyota 86 adalah CLA-Class.',
      price: '830 Jt',
      spec: 'Tempat Duduk : 4 Kursi \nMesin : 1998cc\nTenaga : 197 hp\nSteering : Ya\nKantong Udara Pengemudi : Ya \nAnti Lock Braking System : Ya\nTransmisi : Automatic',
      star: '4.0',
      release: '2022',
      madeby: 'Toyota',
      imageAsset: 'gambar/ft86.png',
      imageUrls: [
  ...
  CarsData(name: 'TOYOTA RAIZE',
      desc: 'Toyota Raize 2022 adalah 5 Seater SUV yang tersedia dalam daftar harga Rp 225,95 - Rp 294,85 Juta di Indonesia. Ini tersedia dalam 12 warna, 6 varian, 2 pilihan mesin, dan 2 opsi transmisi: Manual dan CVT di Indonesia. Mobil ini memiliki ground clearance 200 mm dengan dimensi sebagai berikut: 4030 mm L x 1710 mm W x 1635 mm H. Lebih dari 2 pengguna telah memberikan penilaian untuk Raize berdasarkan fitur, jarak tempuh, kenyamanan tempat duduk dan kinerja mesin. Cicilan bulanan terendah dimulai dari Rp 21,99 Juta (selama 60 bulan). Pesaing terdekat Toyota Raize adalah Rocky, Rush, Sonet dan Glory 580.',
      price: '294 Jt',
      spec: 'Tempat Duduk : 5 Kursi \nMesin : 1998cc\nTenaga : 87 hp\nSteering : Ya\nKantong Udara Pengemudi : Ya \nAnti Lock Braking System : Ya\nTransmisi : Automatic\nGround Clearance : 200 mm',
      star: '4.5.0',
      release: '2022',
      madeby: 'Toyota',
      imageAsset: 'gambar/raize.png',
      imageUrls: [
        'gambar/raize/raizedepan.png',
        'gambar/raize/raizebelakang.png',
        'gambar/raize/raizedashboard.png',
        'gambar/raize/raizekursi.png',
      ],
  ),
  CarsData(
    name: 'KIA SONET',
    desc: 'KIA Sonet 2022 adalah 5 Seater SUV yang tersedia dalam daftar harga Rp 201,6 - Rp 299,9 Juta di Indonesia. Ini tersedia dalam 6 warna, 6 varian, 1 pilihan mesin, dan 2 opsi transmisi: Manual dan iVT di Indonesia. Dimensi Sonet adalah 4120 mm L x 1790 mm W x 1615 mm H. Lebih dari 1 pengguna telah memberikan penilaian untuk Sonet berdasarkan fitur, jarak tempuh, kenyamanan tempat duduk dan kinerja mesin. Cicilan bulanan terendah dimulai dari Rp 28,95 Juta (selama 60 bulan). Pesaing terdekat KIA Sonet adalah Raize, Glory 560, Magnite dan Sonet 7-Seater.',
    price: '201 Jt',
    spec: 'Tempat Duduk : 5 Kursi \nMesin : 1497cc\nTenaga : 113 hp\nSteering : Ya\nKantong Udara Pengemudi : Ya \nAnti Lock Braking System : Ya\nTransmisi : Automatic',
    star: '5.0',
    release: '2022',
    madeby: 'KIA',
    imageAsset: 'gambar/sonet.png',
    imageUrls: [
      'gambar/sonet/sonetdepan.png',
      'gambar/sonet/sonetbagasi.png',
      'gambar/sonet/sonetdashboard.png',
      'gambar/sonet/sonetkursi.png',
    ],
  ),
  CarsData(
      name: 'MINI CLUBMAN',
      desc: 'MINI Clubman 2022 adalah 5 Seater Hatchback yang tersedia dalam daftar harga Rp 904 Juta - Rp 1,4 Milyar di Indonesia. Ini tersedia dalam 13 warna, 3 varian, 2 pilihan mesin, dan 2 opsi transmisi: Dual Clutch dan Otomatis di Indonesia. Mobil ini memiliki ground clearance 141 mm dengan dimensi sebagai berikut: 4266 mm L x 1800 mm W x 1441 mm H. Pesaing terdekat MINI Clubman adalah A-Class, Countryman, 3 Door dan 5 Door.',
      price: '904 Jt',
      spec: 'Tempat Duduk : 5 Kursi \nMesin : 1499cc\nTenaga : 136 hp\nSteering : Ya\nKantong Udara Pengemudi : Ya \nAnti Lock Braking System : Ya\nTransmisi : Automatic\nGround Clearance	: 141 mm',
      star: '4.9',
      release: '2022',
      madeby: 'MINI',
      imageAsset: 'gambar/mini.png',
      imageUrls: [
        'gambar/mini/minidepan.png',
        'gambar/mini/minibelakang.png',
        'gambar/mini/minidashboard.png',
        'gambar/mini/minikursi.png',
      ],
  ),
];
